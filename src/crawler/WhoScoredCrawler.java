...
import data.Match;
import data.Player;
import data.PlayerMatchStatistic;
import data.RedCard;
import data.TeamMatchStatistic;
import data.YellowCard;
import function.ClubFunction;
import function.GoalFunction;
import function.LeagueFunction;
import function.MatchFunction;
import function.PlayerFunction;
import function.PlayerMatchStatisticFunction;
import function.RedCardFunction;
import function.TeamMatchStatisticFunction;
import function.YellowCardFunction;
                    ...
                    if (td.findElements(By.cssSelector("div")).size() > 1) {
                        ...
                        for (WebElement event : events) {
                            ...
                            if (!event.getAttribute("class").equals("clear")) {
                                ...
                                int minute = Integer.parseInt(data.getAttribute("data-minute"));
                                int second = Integer.parseInt(data.getAttribute("data-second"));
                                String type = data.getAttribute("data-type");
                    ...
                    if (td.findElements(By.cssSelector("div")).size() > 1) {
                        ...
                        for (WebElement event : events) {
                            ...
                            if (!event.getAttribute("class").equals("clear")) {
                                ...
                                switch (type) {
                                    case "17":
                                        String cardType = data.getAttribute("data-card-type");
